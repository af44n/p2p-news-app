...
***************************************/
  ...
  ***************************************/
  ...
  async function init_blog ({ username }) {
    ...
    const { swarm } = await identity.network({ action: 'blog peer discovery and replication' })
    if (swarm) {
      ...
      console.warn('p2p-news-app: Offline mode, network not joined.')
    }
...
},{"./endian":14,"b4a":5}],18:[function(require,module,exports){
